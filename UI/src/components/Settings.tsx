...
export function Settings({ user }) {
  ...
  <div className="space-y-6">
    ...
    <div>
      ...
      <p className="text-muted-foreground">Configure application and clinic preferences</p>
    </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Short bio or clinic introduction"
              />
            </div>
      ...
      <TabsContent value="clinic" className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Clinic information and contact details</CardDescription>
          </CardHeader>
      ...
      <TabsContent value="notifications" className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            {/* Loop 2 - Channels */}
            <div className="space-y-4">
              <h3 className="text-lg">Notification Channels</h3>
