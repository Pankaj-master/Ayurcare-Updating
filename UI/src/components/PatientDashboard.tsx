  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl text-foreground">Today's Diet Plan</h1>
          <p className="text-muted-foreground">Stay on track with your Ayurvedic diet journey</p>
        </div>
          ...
          return (
            <Card key={index}>
              <CardContent className="p-6">
                ...
                <p className="text-xs text-muted-foreground mt-2">{stat.percentage}% of daily goal</p>
              </CardContent>
            </Card>
          );
        })}
          ...
          return (
            <Card key={mealType}>
              <CardHeader>
                ...
                <CardDescription>
                  {completedMeals === meals.length ? 'Completed' : `${meals.length - completedMeals} items remaining`}
                </CardDescription>
              </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Don't miss your scheduled activities</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Access your important features</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
